...
export default function PaginaInicial() {
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-center min-h-[800] bg-primary bg-cover bg-blend-multiply bg-fixed">
                <div className="flex items-center justify-between flex-col border border-solid border-2 border-slate-300 h-full sm:flex-row w-full max-w-screen-lg rounded p-8 m-4 shadow-md bg-green-700">
                    <form onSubmit={handleFormSubmit} className="flex flex-col items-center justify-center w-full sm:w-1/2 mb-4 sm:mb-0">
                        ...
                        <input
                            value="Entrar"
                            type="submit"
                            className="w-80 h-14 flex items-center cursor-pointer my-4 justify-center p-4 font-medium text-2xl text-center rounded border border-solid border-2 border-slate-300 text-white bg-blue-500"
                        />
                    </form>
